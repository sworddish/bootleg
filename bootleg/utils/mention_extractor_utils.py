...
try:
    ...
    # TODO: path need to be set in run_config.yaml, but here flair model only for testing 
    tagger_fast = SequenceTagger.load("/opt/data/cchang/bootleg_train/models/flair_ner_model.pt")
except ImportError:
    tagger_fast = None
